...
#%% LOAD RAW DATA
# Read the whole file
data_name = 'BC840_2013-10-15_2013-11-15'
fname = data_name + '.txt'

day = 96
h_min, h_max = 100, 500
# Keep 25 days (the last 6 days have too many missing values)
num_keep = 25
...
# Xcop, xemp = du.toGaussCopulat(XX)
# Xim, params = du.imputeMissing(Xcop, method='gaussian')


# Fix missing
for ii in range(12):
    midx = missing_idx[ii]
    ne_impute[:, midx] = np.mean(ne_impute[:, midx-2:midx+2], axis=1)
