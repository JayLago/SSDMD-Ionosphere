...
if saveFigs
    exportgraphics(fig, './results/Boulder/fig_data_2013.eps', ...
        'Resolution', 300)
    close(fig);
end
...
% fig1 = gcf;
% fig1.Units = 'inches';
% set(fig1, 'Position', [0 5.6250 12.6111 6.3889])
ylim([-1 40])
fig = gcf;
fig.Units = 'inches';
...
if saveFigs
    exportgraphics(fig, './results/Boulder/fig_avg_model_slices_2013.eps', ...
        'Resolution', 300)
    close(fig);
end
